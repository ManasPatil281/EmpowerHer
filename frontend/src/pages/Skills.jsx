          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {filteredSkills.map((skill) => (
              ...
              >
                ...
                {skill.videoUrl && (
                  <div 
                    className="absolute top-0 left-0 right-0 h-48 flex items-center justify-center bg-black bg-opacity-30 hover:bg-opacity-50 transition-all"
                    onClick={(e) => {
                      e.stopPropagation();
                      handleThumbnailClick(e, skill.videoUrl);
                    }}
                  >
